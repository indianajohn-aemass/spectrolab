...
int main(int argc, char** argv){
 ...
 if (mgrabber.getFrameCount() ==0) {
	 std::cout <<" Folder has no PCDS!\n";
	 return -1;
 }
 std::cout << "Playing movie in "<< infile << " directory with " << mgrabber.getFrameCount() << " frames\n";

 mgrabber.registerCallback<pcl::MovieGrabber::sig_xyzi_cb>(
